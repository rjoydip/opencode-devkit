...
export default tool({
  description:
    "Run the test suite with optional coverage, watch mode, or specific test patterns. Automatically detects package manager (bun, pnpm, npm, yarn) and test framework.",
  args: {
    pattern: tool.schema
      .string()
      .optional()
